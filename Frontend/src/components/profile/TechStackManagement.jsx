...
function TechStackManagement({ techStack, onUpdate }) {
    ...
    return (
        <div className="bg-white/10 rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-white/20">
            ...
            {success && (
                <div className="bg-green-500/20 border border-green-500/30 text-green-200 px-6 py-4 rounded-2xl mb-6 backdrop-blur-sm flex items-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    ...
                    <div className="flex space-x-3">
                        <input
                            ...
                            className="flex-1 px-4 py-3 bg-white/5 border border-white/20 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-white placeholder-gray-400"
                        />
                        <button
                            type="button"
                            onClick={handleAddTech}
                            className="bg-indigo-500/80 text-white px-6 py-3 rounded-2xl hover:bg-indigo-500 transition-colors focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 backdrop-blur-sm"
                        >
                ...
                <button
                    type="submit"
                    className="w-full bg-indigo-500/80 hover:bg-indigo-500 text-white px-6 py-3 rounded-2xl transition-colors backdrop-blur-sm"
                >
                    Update Tech Stack
                </button>
            </form>
